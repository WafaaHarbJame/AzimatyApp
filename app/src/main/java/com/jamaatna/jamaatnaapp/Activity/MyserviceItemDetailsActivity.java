...
import com.jamaatna.jamaatnaapp.Adapter.PersonsAdapterAdapter;
import com.jamaatna.jamaatnaapp.Adapter.SliderAdapterExample1;
...
import com.jamaatna.jamaatnaapp.Model.RateingBottomDialog;
...
public class MyserviceItemDetailsActivity extends BaseActivity {
    ...
    int list_id;
    String token;
    private ImageButton mDeletelist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myservice_item_details);
        ...
        mDeletelist = findViewById(R.id.deleteservice);
        mEdit = findViewById(R.id.edit);
        mVisble = findViewById(R.id.visble);

        layoutManager = new LinearLayoutManager(getActiviy());
        ...
        mVisble.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(AppConstants.service_id,list_id);
                    ...
                    if (status == 1) {
                        ...
                        for (int j = 0; j < list.length(); j++) {
                            ...
                            for (int l = 0; l < item_comments.length(); l++) {
                                ...
                                psersonRatingList.add(new PsersonRating(user_comment_name, 1, comment, comment_date, user_comment_photo, comment_rating));
                            }
...
//                Toast.makeText(getActiviy(), error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void DeleteList(int item_id, final String token) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                AppConstants.DELEET_item+item_id+"/delete"
