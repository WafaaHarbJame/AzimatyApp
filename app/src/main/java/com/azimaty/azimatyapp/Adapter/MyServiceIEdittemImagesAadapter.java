...
public class MyServiceIEdittemImagesAadapter extends RecyclerView.Adapter<MyServiceIEdittemImagesAadapter.MyHolder>{
    ...
    public MyServiceIEdittemImagesAadapter(Context context, List<Items_image_service> items_image_services){
        this.items_image_services = items_image_services;
        this.context = context;
        this.inflater = LayoutInflater.from(context);
    }

    public MyServiceIEdittemImagesAadapter(Context context, List<Items_image_service> areas_counseling_models, String categoryId){
        this.items_image_services = items_image_services;
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        this.categoryId = categoryId;
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.my_update_item_image,parent,false);
