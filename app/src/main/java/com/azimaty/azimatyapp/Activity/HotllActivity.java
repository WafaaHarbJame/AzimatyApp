...
public class HotllActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotll);
        mMenu = findViewById(R.id.menu);
        mBack = findViewById(R.id.back);
        mRvCity = findViewById(R.id.rv_city);
        mFamilyrecycler = findViewById(R.id.familyrecycler);

        linearLayoutManager = new LinearLayoutManager(HotllActivity.this);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(HotllActivity.this);
        ItemAdapter itemAdapter = new ItemAdapter(buildItemList(), HotllActivity.this);
        ...
        mBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HotllActivity.this, HomeActivity.class);
